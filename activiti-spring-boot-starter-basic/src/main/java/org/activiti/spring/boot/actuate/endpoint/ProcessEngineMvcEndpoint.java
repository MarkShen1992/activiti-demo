...
public class ProcessEngineMvcEndpoint {
    ...
    /**
     * Look up the process definition by key. For example, this is
     * <A href="http://localhost:8080/activiti/processes/fulfillmentProcess">process-diagram for</A> a process
     * definition named {@code fulfillmentProcess}.
     */
    @RequestMapping(value = "/processes/{processDefinitionKey:.*}", method = RequestMethod.GET,
